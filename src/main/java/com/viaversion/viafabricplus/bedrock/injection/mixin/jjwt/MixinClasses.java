...
package com.viaversion.viafabricplus.bedrock.injection.mixin.jjwt;
...
public abstract class MixinClasses {
     ...
     */
    @Overwrite
    public static <T> Class<T> forName(final String fqcn) throws UnknownClassException, ClassNotFoundException {
